// ─── Legacy Kind Mapping Tables (SERVER MIRROR) ─────────────────────────────
// This file MUST stay in sync with src/shared/legacy-mappings.ts in values.
// Only the import path differs (Deno vs Node).

import type { ContractKind, InteractionKind, TransportKind, SpecFormat } from "./enums.ts";
