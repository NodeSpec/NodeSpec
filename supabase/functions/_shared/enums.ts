// ─── Canonical enum tuples (SERVER MIRROR) ───────────────────────────────────
// This file MUST stay byte-identical to src/shared/enums.ts in values.
// If you change enum values here, change them in src/shared/enums.ts too.
// The only difference is the zod import path (npm: prefix for Deno).
